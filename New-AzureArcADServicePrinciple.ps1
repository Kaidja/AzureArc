...
$AARCServicePrincipal = New-AzADServicePrincipal @NewAADSPNDetails

#Print out the Service Princile information
$AARCServicePrincipal

#The following code will allow you to export the secre
#https://docs.microsoft.com/en-us/powershell/azure/create-azure-service-principal-azureps?view=azps-6.4.0
